...
const nodeCategories = [
  {
    ...
    items: [
      ...
      { id: 'anthropic-api', label: 'Claude API', type: 'input', subtype: 'api', provider: 'anthropic', protocol: 'Anthropic', baseUrl: 'https://api.anthropic.com', icon: Globe, className: 'Claude API' },
