...
const nodeCategories = [
  {
    ...
    items: [
      ...
      { id: 'anthropic-api', label: 'Claude Code API', type: 'input', subtype: 'api', provider: 'anthropic', protocol: 'Claude Code API → Anthropic', adapter: 'claude-code-api-to-anthropic', baseUrl: 'https://api.anthropic.com', localPort: 39124, localApiKey: 'claude-code-api-local-key', icon: Globe, className: 'Claude Code API' },
